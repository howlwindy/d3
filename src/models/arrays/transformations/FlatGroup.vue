...
const result0 = ref<[string, string[]][]>(d3.flatGroup(data0.value, (v) => v))
const input0 = (v: string) => (result0.value = d3.flatGroup(v, (v) => v))
